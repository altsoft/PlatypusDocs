...
(cd ./Quick_Start/; publican build --formats pdf,html --langs en-US --config publican_en.cfg)
cp -a ./Quick_Start/tmp/en-US/pdf/. ./dist
...
java -cp ./HtmlConvertor/lib/jsoup-1.7.3.jar:./HtmlConvertor/build/classes com.eas.htmlconvertor.HtmlConvertor -src ./Quick_Start/tmp/en-US/html -dest ./dist/Quick_Start -layout ./HtmlLayout
