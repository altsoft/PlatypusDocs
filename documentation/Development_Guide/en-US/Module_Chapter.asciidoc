...
Platypus.js applications can handle WebSocket messages. Regular server modules can be used as WebSocket endpoint.
...
Unfortunately, only one word WebSocket modules names are allowed.
-------------------------------------------------------------------------------------------
